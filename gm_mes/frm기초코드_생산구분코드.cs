...
namespace gm_mes
{
    public partial class frm기초코드_생산구분코드 : Form
    {
        String sql = "";
        public frm기초코드_생산구분코드()
        {
            InitializeComponent();
        }

        private void frm기초코드_생산구분코드_Load(object sender, EventArgs e)
        {
            초기화();
            조회();
            조회2();
        ...
        private void spr3_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            txt36.Text = spr3.ActiveSheet.Cells[e.Row, 5].Text;
            txt37.Text = spr3.ActiveSheet.Cells[e.Row, 6].Text;
